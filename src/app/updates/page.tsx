...
const UPDATES = [
  {
    ...
    background:
      "AdSense 審査で重視される「誰が、どの方針で運営し、どのように改善しているか」を明確に示す必要があったためです。",
    userValue:
  ...
  },
  {
    ...
    related: { href: "/updates", label: "審査対応後の更新履歴を見る" },
  },
  {
    date: "2026-04-26",
  ...
  {
    date: "2026-03-24",
    title: "AdSense 審査向けの基盤品質を初回強化",
    change:
      "プライバシー情報、404整備、誤クリック対策、Thin Content対策、審査向け構造の見直しをまとめて実施しました。",
    background:
